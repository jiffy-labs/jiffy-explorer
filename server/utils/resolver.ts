...
export const resolvers: Resolvers = {
    UserOp: {
        ...
        indexerName: (root: any, args: any, context: any, info: any) => root.indexerName || context.indexerName || 'optimism-goerli-jiffy-scan' || "matic-jiffy-scan", // The value we provide in the config
    },
    Query: {
